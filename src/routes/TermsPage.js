  ...
  render() {
    return (
      <Layout>
        ...
        <p>
          The CNVS website located at https://cnvs.online is a copyrighted work
          belonging to CNVS. Certain features of the Site may be subject to
        ...
        <p>
          ...
          right; (ii) that is unlawful, harassing, abusive, tortuous,
        ...
        <p>
          Cookies and Web Beacons. Like any other website, CNVS uses ‘cookies’.
